...
#ifndef VR_SEURAT_IMAGE_EXR_IMAGE_READER_H_
#define VR_SEURAT_IMAGE_EXR_IMAGE_READER_H_
...
// This class implements EXR reading.
//
...
class ExrImageReader : public ImageReader {
 public:
  // Create a ExrImageReader that reads from the EXR file contents in
 ...
 private:
  ...
  // Initializes this ExrImageReader with EXR file contents.
  base::Status Init(absl::string_view exr_contents);

  // ExrImageReader uses the PIMPL idiom to hide the internals of OpenEXR from
  // the public header.
  struct Impl;
...
#endif  // VR_SEURAT_IMAGE_EXR_IMAGE_READER_H_
